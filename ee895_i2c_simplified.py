...
try:
    ...
    EE_895.change_measuring_mode(0)
    # read Measuring mode
    ...
    EE_895.change_co2_measuring_interval(150)
    # read  Measuring Interval
    print("Measuring Interval: " + str(EE_895.read_co2_measuring_interval())) 
...
for i in range(30):
    try:
        temperature, co2, pressure = EE_895.get_all_measurements()
